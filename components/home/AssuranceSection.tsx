		...
		<section className="py-24 bg-white dark:bg-slate-950">
			<div className="max-w-6xl mx-auto px-6">
				...
				<div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/30 rounded-[3rem] p-8 md:p-12 shadow-premium relative overflow-hidden">
					...
					<div className="absolute -top-24 -end-24 w-64 h-64 bg-emerald-200/40 dark:bg-emerald-800/20 rounded-full blur-3xl pointer-events-none"></div>
					<div className="absolute -bottom-24 -start-24 w-64 h-64 bg-emerald-200/40 dark:bg-emerald-800/20 rounded-full blur-3xl pointer-events-none"></div>

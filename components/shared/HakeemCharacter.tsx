  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Outer Eyes (White) */}
        <circle cx="70" cy="90" r="24" fill="#FFFFFF" stroke="#4F46E5" strokeWidth="3" />
        <circle cx="130" cy="90" r="24" fill="#FFFFFF" stroke="#4F46E5" strokeWidth="3" />
        ...
        <circle cx="70" cy="90" r="26" stroke="#FACC15" strokeWidth="4" fill="none" />
        <circle cx="130" cy="90" r="26" stroke="#FACC15" strokeWidth="4" fill="none" />
        {/* Glasses Bridge */}
        <path d="M96 90 L104 90" stroke="#FACC15" strokeWidth="4" strokeLinecap="round" />
        {/* Glasses Side Frames */}
        <path d="M44 90 L34 85" stroke="#FACC15" strokeWidth="3" strokeLinecap="round" />
        <path d="M156 90 L166 85" stroke="#FACC15" strokeWidth="3" strokeLinecap="round" />
        ...
        {/* Scarf Base */}
        <path d="M60 160 Q100 175 140 160 Q150 178 135 185 Q100 195 65 185 Q50 178 60 160 Z" fill="#EF4444" />
        <path d="M60 160 Q100 175 140 160 Q150 178 135 185 Q100 195 65 185 Q50 178 60 160 Z" fill="#FFFFFF" clipPath="url(#scarf-clip)" />
        ...
        <path d="M56 160 Q100 176 144 160" stroke="#EF4444" strokeWidth="4" strokeLinecap="round" />
        <path d="M62 184 Q100 196 138 184" stroke="#EF4444" strokeWidth="3" strokeLinecap="round" />

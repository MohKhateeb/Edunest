...
export default function AddStudentForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-card border border-border/80 rounded-3xl p-6 space-y-4 shadow-premium">
      ...
      <div className="space-y-1">
        <label className="text-xs font-bold text-muted-foreground block">اسم الطالب *</label>
        <input
          type="text"
          name="name"
          required
      ...
      <div className="space-y-1">
        <label className="text-xs font-bold text-muted-foreground block">الصف الدراسي *</label>
        <select
          name="grade"
      ...
      <div className="space-y-1">
        <label className="text-xs font-bold text-muted-foreground block">المدرسة (اختياري)</label>
        <input
          type="text"
          name="school"

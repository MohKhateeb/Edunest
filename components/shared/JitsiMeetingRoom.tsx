...
export default function JitsiMeetingRoom({
	...
	return (
		...
		>
			...
			<div className="absolute top-0 end-0 start-0 h-14 bg-gradient-to-b from-black/90 to-transparent z-10 flex items-center justify-between px-6 pointer-events-none">
			...
			<div className="absolute bottom-6 end-1/2 -translate-x-1/2 z-10 flex items-center gap-3 bg-black/60 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/10 shadow-2xl transition-all hover:bg-black/70">
				<button

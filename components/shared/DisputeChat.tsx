					...
					{messages.map((msg) => {
						...
						return (
							...
							>
								...
								<div
									className={`max-w-[80%] p-3 rounded-2xl ${
										isAdminMsg
											...
											: isMe
												? "bg-blue-600 text-white rounded-ss-none"
												: isSenderAdmin
													? "bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/50 text-red-900 dark:text-red-100 rounded-se-none shadow-sm"
													: "bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 text-gray-800 dark:text-gray-100 rounded-se-none shadow-sm"
									}`}
								>
								...
								{!isAdminMsg && (
									<div
										className={`text-[10px] mt-1 text-start ${isMe ? "text-gray-400" : "text-gray-400"}`}
									>

    ...
    >
      <div className="shrink-0 relative flex items-end drop-shadow-md z-10 w-20 h-20 md:w-24 md:h-24">
        {character === 'hakeem' ? (
          ...
          <NajeebCharacter size="sm" mode={najeebMode as any} className="w-full h-full object-contain object-bottom" />
        )}
      </div>
      ...
      <div
        className={cn(
          ...
          character === 'hakeem' ? 'border-r-4 border-r-blue-400' : 'border-l-4 border-l-amber-400'
        )}
      >

...
export function PaymentModal({ bookingId, price, onClose }: { bookingId: string; price: number; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6 relative overflow-hidden">
        {/* Decorative Header */}
        ...
        <div className="text-center mb-6 mt-2">
          ...
          <h3 className="text-xl font-bold text-gray-900 dark:text-white">تأكيد عملية الدفع</h3>
          <p className="text-gray-500 dark:text-gray-400 mt-2 text-sm">سيتم خصم المبلغ من بطاقتك الائتمانية لتأكيد الحجز.</p>
        </div>

        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 mb-6">
          <div className="flex justify-between items-center mb-2">
            <span className="text-gray-600 dark:text-gray-300">قيمة الجلسة</span>
            <span className="font-semibold text-gray-900 dark:text-white">{price} شيكل</span>
          </div>
          <div className="flex justify-between items-center mb-2">
            <span className="text-gray-600 dark:text-gray-300">رسوم إضافية</span>
            <span className="font-semibold text-gray-900 dark:text-white">0 شيكل</span>
          </div>
          <div className="border-t border-gray-200 dark:border-gray-600 my-2 pt-2 flex justify-between items-center">
            <span className="text-gray-900 dark:text-white font-bold">الإجمالي</span>
            <span className="text-2xl font-bold text-blue-600 dark:text-blue-400">{price} شيكل</span>
          </div>
        </div>

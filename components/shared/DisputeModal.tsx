...
export function DisputeModal({ bookingId, onClose }: { bookingId: string; onClose: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl w-full max-w-lg p-6 relative">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white">تقديم اعتراض على الجلسة</h3>
            <p className="text-gray-500 dark:text-gray-400 text-sm">سيتم تجميد الدفع للمعلم حتى تفصل الإدارة في الأمر.</p>
          </div>
        </div>

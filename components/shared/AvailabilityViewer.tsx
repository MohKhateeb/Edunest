...
export default function AvailabilityViewer({ availability }: AvailabilityViewerProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm">
      <h3 className="font-extrabold text-base border-b border-border pb-2.5">ساعات العمل الأسبوعية المتاحة</h3>

		...
		<Portal>
			...
			>
				...
				>
					...
					>
						<h4 className="font-extrabold text-lg text-foreground flex items-center gap-2 border-b border-border/50 pb-3 pt-2 ps-2">
							{title}
						</h4>
							...
							{requireReason && (
								<div className="space-y-1.5">
									...
									<textarea
										...
										disabled={isLoading}
										placeholder={t('alrjaa_twdyh_alsbb_hna')}

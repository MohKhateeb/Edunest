...
import { FAQCategory, FAQ, UserType } from '@prisma/client';
import { revalidatePath } from 'next/cache';
import { ActionResponse } from '@/lib/types';
import { requireAuth } from '@/lib/require-auth';
import { faqSchema, faqUpdateSchema, faqIdSchema } from '@/lib/validations/faq';
...
export async function updateFAQ(
  ...
  try {
    ...
    revalidatePath('/dashboard/admin/faq');
    if (oldFaq) revalidatePath(`/dashboard/${oldFaq.category.toLowerCase()}/faq`);

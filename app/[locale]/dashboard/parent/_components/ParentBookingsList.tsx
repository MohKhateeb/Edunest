		...
		<div className="space-y-6 text-end" dir="rtl">
			...
			<div className="flex flex-col md:flex-row gap-4 justify-between items-center bg-white dark:bg-slate-900 p-2 rounded-2xl border border-border/50 shadow-sm">
				...
				<div className="relative w-full md:w-72">
					...
					<input
						type="text"
						placeholder={t('key_1783109434939_hfb7')}
						className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-border/50 rounded-xl pe-9 ps-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
						value={searchQuery}

...
export default function AdminVerificationQueue({
	...
	const [selectedTeacherDetailsId, setSelectedTeacherDetailsId] = useState<
		string | null
	>(null);
					...
					<div className="space-y-2">
						{requests.map((r) => (
							<button
								...
								className={`w-full text-end p-4 rounded-xl border transition-all flex items-center gap-3 cursor-pointer ${
							...
							>
								...
								<div className="flex-1 min-w-0 space-y-0.5">
									<span className="font-bold text-xs text-foreground/80 truncate block">
										{r.teacher.user.name}
									</span>
					...
					<div className="space-y-6">
						<div className="border-b border-border pb-3 flex justify-between items-start gap-4">
							<div className="flex items-center gap-3">
								...
								<div>
									<h3 className="font-extrabold text-base">
										{activeRequest.teacher.user.name}
									</h3>
							...
							<span className="text-xs text-muted-foreground">
								{t('key_1783109432681_ftxr')}{activeRequest.teacher.city || "غير محدد"}
							</span>
						</div>
						...
						<div className="flex justify-between items-center bg-accent/20 p-3.5 border border-border rounded-xl">
							...
							<button
								type="button"
								onClick={() =>
									setSelectedTeacherDetailsId(activeRequest.teacher.id)
								}
								...
								>
									<div className="space-y-1">
										...
										<textarea
											...
											placeholder={t('key_1783109433115_06dz')}
